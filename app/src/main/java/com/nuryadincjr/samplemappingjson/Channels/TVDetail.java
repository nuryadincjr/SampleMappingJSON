...
import com.nuryadincjr.samplemappingjson.movies.ProductionCompanies;
import com.nuryadincjr.samplemappingjson.movies.ProductionCountries;
import com.nuryadincjr.samplemappingjson.movies.SpokenLanguages;
...
public class TVDetail {
    ...
    private List<LastEpisodeToAir> last_episode_to_air;
    private String name;
    ...
    public List<LastEpisodeToAir> getLast_episode_to_air() {
        return last_episode_to_air;
    }

    public void setLast_episode_to_air(List<LastEpisodeToAir> last_episode_to_air) {
